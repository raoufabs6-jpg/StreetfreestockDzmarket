...
// صفحة تسجيل حساب جديد — تُنشئ مؤسسة + مستخدم المالك (OWNER) وتسجيل الدخول فورًا
...
export default function RegisterPage() {
  ...
  const submit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        // رسائل الخادم واضحة بالعربية (409 البريد مسجّل / 400 تحقق الحقول)
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-8">
      <div className="w-full max-w-md">
        <div className="mb-6 flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="text-xl font-extrabold text-slate-900">{t("auth.registerTitle")}</h1>
